...
<div class="container-fluid">
    ...
    <div class="row g-3">
        <div class="col-md-2">
            <a href="{{ route('tasks.my') }}" class="text-decoration-none">
                <div class="card text-center p-4 shadow-sm border-0" style="background: #f78ca0; color: white;">
                    <h6>Total Tasks</h6>
                    <h4>{{ $totalTasks }}</h4>
                </div>
            </a>
        ...
        <div class="col-md-2">
            <a href="{{ route('tasks.my', ['status' => 'approved']) }}" class="text-decoration-none">
                <div class="card text-center p-4 shadow-sm border-0" style="background: #43cea2; color: white;">
        ...
        <div class="col-md-2">
            <a href="{{ route('tasks.my', ['status' => 'pending']) }}" class="text-decoration-none">
                <div class="card text-center p-4 shadow-sm border-0" style="background: #f7971e; color: white;">
                    <h6>Pending Tasks</h6>
                    <h4>{{ $pendingTasks }}</h4>
                </div>
            </a>
        ...
        <div class="col-md-2">
            <a href="{{ route('tasks.my', ['status' => 'under_review']) }}" class="text-decoration-none">
                <div class="card text-center p-4 shadow-sm border-0" style="background: #36d1dc; color: white;">
                    <h6>Under Review</h6>
        ...
        <div class="col-md-2">
            <a href="{{ route('tasks.my', ['status' => 'rejected']) }}" class="text-decoration-none">
                <div class="card text-center p-4 shadow-sm border-0" style="background: #ff6b6b; color: white;">
                    <h6>Rejected</h6>
                    <h4>{{ $rejectedTasks }}</h4>
                </div>
            </a>
    ...
    <div class="card mt-4 p-3 shadow-sm">
        <h4 class="mb-3">Assigned Tasks @if(request('status')) ({{ ucfirst(request('status')) }}) @endif</h4>
